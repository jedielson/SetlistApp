...
import com.jedi.setlistapp.temp.DatabaseHelper;
import com.jedi.setlistapp.temp.DisciplineDao;
import com.jedi.setlistapp.temp.StudentDao;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			// GET ALL LINES AGAIN BY RAW
				...
				GenericRawResults<Student> raw = studentDao.queryRaw("SELECT id, name FROM student WHERE name LIKE \"Vinicius%\"", new RawRowMapper<Student>(){
					@Override
